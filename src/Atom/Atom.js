...
function Atom(props) {
    ...
    return <path ref={innerRef} className={isActive ? 'selected': null} onClick={toggleClass} d={points} {...rest} /> //id should be added even if not explicit here
}
Atom.css = `path {transform: var(--t);}path.selected {stroke: #ffc200;}`
